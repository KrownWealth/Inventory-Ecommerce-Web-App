import { LanguagSelect, SignUp, SignupWithGoogle } from "@/components/custom-ui/reuseables";
        ...
        <div className="w-1/2 px-12 p-8">
          <div className="w-full flex flex-col gap-8">
            ...
            <div className="flex flex-col space-y-8">
              ...
              <div>
                <h2 className="text-xl font-semibold text-black ">Hi, Welcome to PriceSage</h2>
                <p className="text-pricesageBlack">Create an account and start enjoying PriceSage</p>
              </div>
              <SignupWithGoogle />
            </div>
